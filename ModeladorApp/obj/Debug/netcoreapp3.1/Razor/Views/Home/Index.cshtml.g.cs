#pragma checksum "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "044235897cdf066f2c9f0aad221c664c53e7530e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"044235897cdf066f2c9f0aad221c664c53e7530e", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<ModeladorApp.Models.Entities.TB_PROYECTO>>
    {
...
<style>
    ...
    .colapsado {
        width: 15px;
        /*background-image: url(img/tabler-icon-circle-minus.svg);*/
    ...
    .expand {
        width: 15px;
        background-image: url(img/tabler-icon-circle-plus.svg);
        background-repeat: no-repeat;
...
<script type=""text/javascript"">
    ...
    function getSubMenus(proyId) {

        //console.log(proyId)          
      
        //Comprobar si la data se ha cargado
        if ($('#node_' + proyId).attr('data-loaded') === 'false') {
            
            //console.log(proyId)

            $('#node_' + proyId).addClass(""loadingP"");   // Show loading panel
            $('#node_' + proyId).removeClass(""colapsado"");
            ...
            $.ajax({
                ...
                success: function (d) {
                    ...
                    $");
            WriteLiteral(@"('#node_' + proyId).removeClass(""loadingP"");
                    ...
                    if (d.length > 0) {
                        ...
                        $.each(d, function (i, element) {
                            $ul.append(
                                $(""<li></li>"").append(
                                    '<span class=""colapsado collapsible"" data-loaded=""false"" pid=""' + element.proyID + '"">&nbsp;</span>' +
                                    '<span><a onclick=""editIdentificador(' + element.proyID + ')"">' + element.identificador + '</a></span>' + '-' +
                                    '<span><a onclick=""editNombre(' + element.proyID +')"">' + element.nombre + '</a></span>'
                                )
                            )
                        });

                        $('#node_' + proyId).parent().append($ul);
                        $('#node_' + proyId).addClass('colapsado');
                        $('#node_' + proyId).toggleClass('colapsado expand');");
            WriteLiteral(@"
                        $('#node_' + proyId).closest('li').children('ul').slideDown();
                    }
                    else {
                        // no sub menu
                        $('#node_' + proyId).css({ 'dispaly': 'inline-block', 'width': '15px' });
                    }

                    $('#node_' + proyId).attr('data-loaded', true);
                },
                error: function () {
                    alert(""Error!"");
                }
            ...
            $('#node_' + proyId).toggleClass(""colapsado expand"");
            $('#node_' + proyId).closest('li').children('ul').slideToggle();
        }
            ...
            <div class=""col-auto ms-auto d-print-none"">
                <div class=""btn-list"">
                    ...
                    <a href=""#"" class=""btn btn-primary d-none d-sm-inline-block"" data-bs-toggle=""modal"" data-bs-target=""#modal-report"">
                        ...
                        <svg xmlns=""http://www.w3.org/2000/svg"" class=""icon"" width=""24"" height=""24"" viewBox=""0 0 24 24"" stroke-width=""2"" stroke=""currentColor"" fill=""no");
            WriteLiteral(@"ne"" stroke-linecap=""round"" stroke-linejoin=""round""><path stroke=""none"" d=""M0 0h24v24H0z"" fill=""none"" /><line x1=""12"" y1=""5"" x2=""12"" y2=""19"" /><line x1=""5"" y1=""12"" x2=""19"" y2=""12"" /></svg>
                        Crear Nuevo
                    </a>
...
#nullable restore
#line 223 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Index.cshtml"
...
#nullable disable
            WriteLiteral("                                                                <li>\r\n");
            WriteLiteral("\r\n                                                                    <span class=\"colapsado\"");
            BeginWriteAttribute("id", " id=\"", 8754, "\"", 8773, 2);
            WriteAttributeValue("", 8759, "node_", 8759, 5, true);
#nullable restore
#line 234 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Index.cshtml"
WriteAttributeValue("", 8764, i.ProyID, 8764, 9, false);

#line default
#line hidden
#nullable disable
            EndWriteAttribute();
            BeginWriteAttribute("onclick", " onclick=\"", 8774, "\"", 8808, 3);
            WriteAttributeValue("", 8784, "getSubMenus(\'", 8784, 13, true);
#nullable restore
#line 234 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Index.cshtml"
WriteAttributeValue("", 8797, i.ProyID, 8797, 9, false);
...
#nullable disable
            ...
            EndWriteAttribute();
            WriteLiteral("\r\n                                                                          data-loaded=\"false\"");
            BeginWriteAttribute("pid", " pid=\"", 8904, "\"", 8919, 1);
#nullable restore
#line 235 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Index.cshtml"
WriteAttributeValue("", 8910, i.ProyID, 8910, 9, false);
...
#nullable disable
            WriteLiteral(@"</a>
                                                                    ...
                                                                    <span>
                                                                        <a style=""cursor:pointer""");
            BeginWriteAttribute("onclick", " onclick=\"", 9884, "\"", 9917, 3);
            WriteAttributeValue("", 9894, "editNombre(\'", 9894, 12, true);
#nullable restore
#line 245 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Index.cshtml"
WriteAttributeValue("", 9906, i.ProyID, 9906, 9, false);
...
#nullable disable
            WriteLiteral("</a>\r\n                                                                    </span>\r\n\r\n\r\n                                                                </li>\r\n");
#nullable restore
#line 250 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Index.cshtml"
                                                                }
...
#nullable disable
            WriteLiteral("                                                            </ul>\r\n");
#nullable restore
#line 252 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Index.cshtml"
                                                        }
...
<div class=""modal modal-blur fade"" id=""modal-report"" tabindex=""-1"" role=""dial");
    ...
    <div class=""modal-dialog modal-lg"" role=""document"">
        <div class=""modal-content"">
            ...
            BeginWriteAttribute("value", " value=\"", 18197, "\"", 18223, 1);
#nullable restore
#line 383 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Index.cshtml"
WriteAttributeValue("", 18205, ViewBag.usuarioId, 18205, 18, false);
