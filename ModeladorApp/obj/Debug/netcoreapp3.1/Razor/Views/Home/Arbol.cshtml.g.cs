#pragma checksum "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "97dd1857da55d19cb1a883a4617fe701efa9f831"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"97dd1857da55d19cb1a883a4617fe701efa9f831", @"/Views/Home/Arbol.cshtml")]
    ...
    public class Views_Home_Arbol : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<ModeladorApp.Models.Entities.TB_PERMISOS>>
    {
        ...
        {
            WriteLiteral("<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "97dd1857da55d19cb1a883a4617fe701efa9f8313744", async() => {
                WriteLiteral(@"
 ...
 ");
                            ...
                            switch (data.cmd) {
                                ...
                                case ""remove"":
                                    ...
                                    if (data.cmd == ""remove"" && vPermiso == ""EDITOR"") {
                                        ...
                                        //console.log(node.data.id); // id a eliminar padre e hijo");
                WriteLiteral(@"s.
                ...
                WriteLiteral(@"                         tree.applyCommand(data.cmd, node);
                                ...
                                case ""paste"":
                                    if (CLIPBOARD.mode === ""cut"") {
                                        // refNode ");
                WriteLiteral(@"= node.getPrevSibling();
         ...
         ");
                ...
                WriteLiteral(@"           //console.log(styleresponse);
                                ...
                                case ""bluesubrayado"":
                                    ...
                                    rp");
                WriteLiteral(@"t.then(function (styleresponse) {
                                        //console.log(styleresponse);
                                        if (styleresponse > 0) {
                                ...
                                case ""yellowsubrayado"":
                                    ...
                                    var rpt = applyOrRemoveStyle(node.d");
                WriteLiteral(@"ata.id, ""Yellow"", ""STYLE_APPLY"")
                                    rpt.then(function (styleresponse) {
                                        //console.log(styleresponse);
                                        if (styleresponse > 0) {
     ...
     ");
                ...
                WriteLiteral(@".id); // id del nodo.
                                ...
                                case ""removefoldericon"":
                                    ...
                                    //console");
                WriteLiteral(@".log(node.data.id); // id del nodo.
                                    //addColumn(treeReach, node.data.id);
                                    break;
                                case ""addnchilds"":
                                    //tree.applyCommand(data.cmd, node);
                                ...
                                case ""duplicatelevel"":
                                    //tree.applyCommand(data.cmd, node);
         ");
                WriteLiteral(@"                           //console.log(""Añadir n hijos"");
                                    //console.log(node.data.id);
                                    ...
                                    rpt.then(function (response) {
                                        ...
                                        if (response > 0) {
                                            ...
                                            Swal.fire('ERROR', 'Hubo un problema, no se pudo dupli");
                WriteLiteral(@"car correctamente.', 'warning')
                                        }
                                    });
                ...
                WriteLiteral(@" //console.log(node.data.id); // id del nodo.
                        ...
                        .on(""keydown"", function (e) {
                            var cmd = null;
                            //------------------------------- EVENTO");
                WriteLiteral(@"S DESENCADENADOS POR TECLAS.
               ...
               ");
                ...
                WriteLiteral(@"          break;
                    ...
                    /*
                     * Context menu (https://git");
                WriteLiteral(@"hub.com/mar10/jquery-ui-contextmenu)
                     */
              ...
              ");
                WriteLiteral(@"                  title: ""Nuevo Hijo <kbd>[Ctrl+Shift+N]</kbd>"",
                  ...
                  ");
                WriteLiteral(@"              cmd: ""greensubrayado"",
                            }, {
                                title: ""Subrayar azul"",
                                cmd: ""bluesubrayado"",
                            }, {
     ...
     ");
                ...
                WriteLiteral(@"         //    cmd: ""newcolumn"",
                  ...
                  ");
                WriteLiteral(@"      beforeOpen: function (event, ui) {
                ...
                //console.log(""pr");
                WriteLiteral(@"oyecto de usuario"");
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response > 0) {
                                ...
                                $('#' + tree + i).attr('onchange', ""InsertUpdateTitulo('"" + tree + ""','"" + i + ""','"" + response + ""','"" + idpy + ""','"" + p");
                WriteLiteral(@"ermiso + ""')"");
        ...
        function insertOrUpdateInfoGrilla(tree, id, i, nodeId, permiso) {
            ...
            if (typeof (permiso) === 'undefined' || permiso == ""VIEWER"") {
                ...
                //");
                WriteLiteral(@"tree: referencia al arbol
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response > 0) {
                                ...
                                //cambiamos el id tambien por el nuevo con solo los parametros requeridos para la actualizacion.
                                $('#' + tree + '_co");
                WriteLiteral(@"lvalue_' + i + ""_"" + nodeId).attr('id', tree + '_colvalue' + response);
        ...
        //--------------------------");
                WriteLiteral(@"------ para obtener la info de cada nivel...
        ...
        function fnShowHideColumns(loadedTree) {         
            ...
            if (select == ""HIDEALL"") {
                //for para obt");
                WriteLiteral(@"ener las columnas por indice.
                for (c = 3; c <= 53; c++) {
        ...
        function loadColumnas(loadedTree, vIdProyecto) {
          ...
          ");
                WriteLiteral(@"  $('#tbodyAdminColumnas').remove();
            var cuerpo_columnas = """";
            ...
            titulos.then(function (result) {
                ...
                result.forEach(function (element) {
                    ...
                    if (typeof (idPushed) === 'undefined') {
                      ...
                      ");
                WriteLiteral(@"  cuerpo_columnas = cuerpo_columnas + '<td><input onclick=""fnCheckColumnChanges(' + element.tituloID + ')"" value=' + element.tituloID + ' type=""checkbox"" class=""checkbox_check"" name=""checkbox_check[]"" checked></td>';
                    }
                ...
                option_btns = option_btns + '<button onclick=""fnApplyColumnChanges(`' + lo");
                WriteLiteral(@"adedTree + '`);"" type=""button"" class=""btn btn-primary"" data-bs-dismiss=""modal"">Mostrar</button>';
        ...
        function fnCheckColumnChanges() {
            ...
            if ($('input.checkbox_check').is(':checked') == true) {
                checkedColumns = [];
                va");
                WriteLiteral(@"r m = jQuery('input:checkbox[class=checkbox_check]:checked').length;
                if (m > 0) {
        ...
        function fnApplyColumnChanges(loadedTree) {
            ...
            //ocultar columnas de los che");
                WriteLiteral(@"ckboxes no checkeados.
  ...
  ");
            ...
            if (nroCamposLlenos == 2) {
                ...
                rpt.then(function (response) {
                    ...
                    if (response >= 1) {
                        ...
                        $('#txtCantidad').val("""");
                        $('");
                WriteLiteral(@"#txtNombreBase').val("""");
                        $('#txtPyID').val("""");                        
        ...
        async function addNHijosAsync(v");
                WriteLiteral(@"Cant, vNombre, vIDparent, vIDproject) {
        ...
        var tableToExcel = (function () {
            var uri = 'data:application/vnd.ms-excel;base64,'
                ...
                , format = function (s, c) { return s.replace(/{(\w+)}/g, function (m,");
                WriteLiteral(@" p) { return c[p]; }) }
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "97dd1857da55d19cb1a883a4617fe701efa9f83188948", async() => {
                WriteLiteral(@"
...
#nullable disable
                ...
                BeginWriteAttribute("href", " href=\"", 81012, "\"", 81045, 2);
                WriteAttributeValue("", 81019, "#proyecto_", 81019, 10, true);
#nullable restore
...
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 81046, "\"", 81101, 6);
                WriteAttributeValue("", 81056, "loadTree(\'", 81056, 10, true);
#nullable restore
#line 1565 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 81066, item.ProyectoID, 81066, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 81082, "\',", 81082, 2, true);
                WriteAttributeValue(" ", 81084, "\'", 81085, 2, true);
#nullable restore
#line 1565 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 81086, item.Permiso, 81086, 13, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 81099, "\')", 81099, 2, true);
                EndWriteAttribute();
...
#nullable disable
                ...
                BeginWriteAttribute("id", " id=\"", 86315, "\"", 86345, 2);
                WriteAttributeValue("", 86320, "proyecto_", 86320, 9, true);
#nullable restore
#line 1700 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 86329, item.ProyectoID, 86329, 16, false);
...
#nullable disable
                ...
                BeginWriteAttribute("onclick", " onclick=\"", 86670, "\"", 86737, 5);
                WriteAttributeValue("", 86680, "loadColumnas(\'tree_", 86680, 19, true);
#nullable restore
#line 1707 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 86699, item.ProyectoID, 86699, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 86715, "\',\'", 86715, 3, true);
#nullable restore
#line 1707 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 86718, item.ProyectoID, 86718, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 86734, "\');", 86734, 3, true);
                EndWriteAttribute();
                WriteLiteral(@" data-bs-toggle=""modal"" data-bs-target=""#modal-simple"">
                                ...
                                <span class=""d-none d-sm-inline"">
                                    <select class=""form-select"" id=""selecterColumns"" name=""selecterColumns""");
                BeginWriteAttribute("onchange", " onchange=\"", 87104, "\"", 87157, 3);
                WriteAttributeValue("", 87115, "fnShowHideColumns(\'tree_", 87115, 24, true);
#nullable restore
#line 1713 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 87139, item.ProyectoID, 87139, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 87155, "\')", 87155, 2, true);
                EndWriteAttribute();
                WriteLiteral(">\r\n                                      \r\n                                        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "97dd1857da55d19cb1a883a4617fe701efa9f83199871", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n                                        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "97dd1857da55d19cb1a883a4617fe701efa9f831100933", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n                                    </select>\r\n                                </span>\r\n\r\n                                <span class=\"d-none d-sm-inline\">\r\n                                    <a");
                BeginWriteAttribute("onclick", " onclick=\"", 87542, "\"", 87586, 3);
                WriteAttributeValue("", 87552, "expandOrContract(", 87552, 17, true);
#nullable restore
#line 1721 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 87569, item.ProyectoID, 87569, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 87585, ")", 87585, 1, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"btn btn-secondary\">\r\n                                        Expandir/Contraer\r\n                                    </a>\r\n                                </span>\r\n");
#nullable restore
#line 1725 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
");
#nullable restore
#line 1732 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
                                }
...
#nullable disable
                WriteLiteral("                            </div>\r\n                        </div>\r\n                    </div>\r\n\r\n\r\n                    <table");
                BeginWriteAttribute("id", " id=\"", 88346, "\"", 88372, 2);
                WriteAttributeValue("", 88351, "tree_", 88351, 5, true);
#nullable restore
#line 1738 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 88356, item.ProyectoID, 88356, 16, false);
...
#nullable disable
                ...
                WriteLiteral(@">
                        ...
                        <thead>
                            <tr");
                BeginWriteAttribute("id", " id=\"", 88658, "\"", 88689, 2);
                WriteAttributeValue("", 88663, "head_tree_", 88663, 10, true);
#nullable restore
#line 1745 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 88673, item.ProyectoID, 88673, 16, false);
...
");
#nullable restore
#line 1810 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
            }
