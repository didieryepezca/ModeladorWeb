#pragma checksum "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d9d6e9ecdebbc2c2896bd89b2cf681eb3eb00797"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d9d6e9ecdebbc2c2896bd89b2cf681eb3eb00797", @"/Views/Home/Arbol.cshtml")]
    ...
    public class Views_Home_Arbol : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<ModeladorApp.Models.Entities.TB_PERMISOS>>
    {
        ...
        {
            WriteLiteral("<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d9d6e9ecdebbc2c2896bd89b2cf681eb3eb007973612", async() => {
                WriteLiteral(@"
        ...
        async function loadTree(vIdProject, vPermiso) {
            ...
            if (data.length >= 1) {
                ...
                WriteLiteral(@"   .eq(2)
                        ...
                        renderColumns: function (event, data) {
                            ...
                            $tdList[0].hidden = true;
                            $tdList[1].hidden = true;
                            //mostrar u ocultar columnas
            ...
            ");
                            ...
                            titles.then(function (result) {
                                ...
                                if (result.length != 0) {
                                    ...
                                    for (h = 0; h <= result.length - 1; h++) {
                                        ...
                                        colName = colName + '<th id=""' + treeReach + '_th' + h + '"" ><input id=""' + treeReach + '_colname_' + result[h].tituloID + '"" onchange=""InsertUpdateTitulo(`' + treeReach + '_colname`,' + h + ',' + result[h].titu");
                WriteLiteral(@"loID + ',' + pySelected + ',' + vPermiso + ' )"" type=""text"" value=""' + result[h].titulo + '""></th>';
                                    }
                                    ...
                                    for (i = 1; i <= 50; i++) {
                                        ...
                                        $('#");
                WriteLiteral(@"' + treeReach + '_th' + i).remove(); //removemos para que no se vuelvan a crear.
                                        colName = colName + '<th id=""' + treeReach + '_th' + i + '"" ><input id=""' + treeReach + '_' + i + '"" onchange=""InsertUpdateTitulo(`' + treeReach + '_colname`,' + i + ',' + 0 + ',' + pySelected + ',' + vPermiso + '  )"" type=""text"" placeholder=""col nombre ' + i + '""></th>';
                                    }
                                    $('#head_' + treeReach).append(colName).fadeIn(300000);
                            ...
                            info.then(function (result) {                                
                                ...
                                // Si la longitud de");
                WriteLiteral(@"l resultado es distinta de 0 hay datos.
                                if (result.length != 0) {
                                    ...
                                    for (n = 0; n <= result.length - 1; n++) {
                                        ...
                                        for (j = m; j <= 51; j++) {
                                            ...
                                            $tdList.eq(j).html('<input id=""' + treeReach + '_colvalue_' + j + '_' + node.data.id + '"" onchange=""insertOrUpdateInfoGrilla(`tree_' + pySelected + '`,`' + 0 + '`,`' + j + '`,`' + node.data.");
                WriteLiteral(@"id + '`,`' + vPermiso + '`)"" type=""text""/>');
                            ...
                            //$tdList.eq(2).html('<input type=""text");
                WriteLiteral(@""" value=""' + node.data.id + '"">');
                        },
                ...
                WriteLiteral(@"    type: ""POST"",
                                ...
                                case ""cut"":
                                    CLIPBOARD");
                WriteLiteral(@" = { mode: data.cmd, data: node };
                                    break;
                                case ""copy"":
                                    CLIPBOARD = {
                                        mode: data.cmd,
             ...
             ");
                WriteLiteral(@"                       //console.log(node.data.id); // id del nodo.
                        ...
                        .on(""keydown"", function (e) {
                            ...
                            // console.log(e.type, $.ui.fancyt");
                WriteLiteral(@"ree.eventToString(e));
    ...
    ");
             ...
             ");
                WriteLiteral(@"           delegate: ""span.fancytree-node"",
                        menu: [
                            {
                            ...
                            },
                            {
                                ...
                                cmd: ""addChild"",
              ");
                WriteLiteral(@"                  uiIcon: ""ui-icon-arrowreturn-1-e"",
                            }, {
  ...
  ");
        ...
        function funGetPyFromUsuario(vIdProject) {
            ...
            return $.get(url, ");
                WriteLiteral(@"{ idProyecto: vIdProject }, function (data) {
                //console.log(data);
            });
        };
        ...
        function funGetInfoFromDB(lvlID) {
            ...
            re");
                WriteLiteral(@"turn $.get(url, { lvlId: lvlID }, function (data) {
                //console.log(data);
            });
        }
        ...
        function insertOrUpdateInfoGrilla(tree, id, i, nodeId, permiso) {            
            ...
            if (typeof (permiso) === 'undefined' || permiso == ""VIEWER"") {
                ...
                if (id > 0) {
                    ...
                    var valorCajaUpdate = $('#' + tree + '_colvalue' + id).");
                WriteLiteral(@"val();
               ...
               ");
                WriteLiteral(@"                     didOpen: (toast) => {
                                ...
                                Swal.fire({
                                    ...
                                    didOpen: (toast) => {
                                        toast.addEventList");
                WriteLiteral(@"ener('mouseenter', Swal.stopTimer)
                                        toast.addEventListener('mouseleave', Swal.resumeTimer)
                                    }
                                })
                            }
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response > 0) {
                                ...
                                //removemos la funcion onchange y la volvemos a agregar solo con los parametros neces");
                WriteLiteral(@"arios para la actualizacion.
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d9d6e9ecdebbc2c2896bd89b2cf681eb3eb0079754468", async() => {
                WriteLiteral(@"
...
");
#nullable restore
#line 980 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                ...
                BeginWriteAttribute("href", " href=\"", 48180, "\"", 48213, 2);
                WriteAttributeValue("", 48187, "#proyecto_", 48187, 10, true);
#nullable restore
#line 983 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 48197, item.ProyectoID, 48197, 16, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 48214, "\"", 48269, 6);
                WriteAttributeValue("", 48224, "loadTree(\'", 48224, 10, true);
#nullable restore
#line 983 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 48234, item.ProyectoID, 48234, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 48250, "\',", 48250, 2, true);
                WriteAttributeValue(" ", 48252, "\'", 48253, 2, true);
#nullable restore
#line 983 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 48254, item.Permiso, 48254, 13, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 48267, "\')", 48267, 2, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"nav-link\"\r\n                   data-bs-toggle=\"tab\">");
#nullable restore
#line 984 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                WriteLiteral(")</a>\r\n            </li>\r\n");
#nullable restore
#line 986 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
        }
...
");
#nullable restore
#line 1109 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
             foreach (var item in Model)
            {
...
#nullable disable
                ...
                BeginWriteAttribute("id", " id=\"", 53009, "\"", 53039, 2);
                WriteAttributeValue("", 53014, "proyecto_", 53014, 9, true);
#nullable restore
#line 1111 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 53023, item.ProyectoID, 53023, 16, false);
                    ...
                    <div class=""row align-items-center"">
                        <div class=""col-auto ms-auto d-print-none"">
                            <div class=""btn-list"">
                                <span class=""d-none d-sm-inline"">
                                    <a");
                BeginWriteAttribute("onclick", " onclick=\"", 53329, "\"", 53373, 3);
                WriteAttributeValue("", 53339, "expandOrContract(", 53339, 17, true);
#nullable restore
#line 1117 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 53356, item.ProyectoID, 53356, 16, false);
...
");
#nullable restore
#line 1128 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
                                }
...
#nullable disable
                WriteLiteral("                            </div>\r\n                        </div>\r\n                    </div>\r\n\r\n\r\n                    <table");
                BeginWriteAttribute("id", " id=\"", 54133, "\"", 54159, 2);
                WriteAttributeValue("", 54138, "tree_", 54138, 5, true);
#nullable restore
#line 1134 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 54143, item.ProyectoID, 54143, 16, false);
...
#nullable disable
                ...
                WriteLiteral(@">
                        ...
                        <thead>
                            <tr");
                BeginWriteAttribute("id", " id=\"", 54445, "\"", 54476, 2);
                WriteAttributeValue("", 54450, "head_tree_", 54450, 10, true);
#nullable restore
#line 1141 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 54460, item.ProyectoID, 54460, 16, false);
...
");
#nullable restore
#line 1206 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
            }
