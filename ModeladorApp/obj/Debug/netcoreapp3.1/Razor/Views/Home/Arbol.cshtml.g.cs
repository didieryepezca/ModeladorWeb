#pragma checksum "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "336f6302f67c02723665e72028e379547b8fa114"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"336f6302f67c02723665e72028e379547b8fa114", @"/Views/Home/Arbol.cshtml")]
    ...
    public class Views_Home_Arbol : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<ModeladorApp.Models.Entities.TB_PERMISOS>>
    {
        ...
        {
            WriteLiteral("<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336f6302f67c02723665e72028e379547b8fa1145659", async() => {
                WriteLiteral(@"
...
");
      ...
      ");
                ...
                WriteLiteral(@"odoActivo = node;
                                    ...
                                    //console.log(node.");
                WriteLiteral(@"data.id); // id del nodo.
                                    //addColumn(treeReach, node.data.id);
                                    break;
                                //case ""hidegrid"":
                                //    //tree.applyCommand(data.cmd, node);
...
");
                ...
                WriteLiteral(@"    , {
                            ...
                            {
                           ");
                WriteLiteral(@"     title: ""Subrayar verde"",
                                cmd: ""greensubrayado"",
                            }, {
                                title: ""Subrayar azul"",
                                cmd: ""bluesubrayado"",
 ...
 ");
        ...
        async function funGetInfo(lvlID) {
            ...
            //va");
                WriteLiteral(@"r info = await funGetInfoFromDB(lvlID);
            //console.log(info)
        };
    ...
    ");
       ...
       ");
        ...
        //------------------------------>>> Chekar todos los checkboxes de los campos de las column");
                WriteLiteral(@"as
        ...
        function fnApplyColumnChanges(loadedTree) {
            ...
            if (unCheckedColumns > 0) {
                jQuery(""input:checkbox:not(:checked)"").each(function () {
                    ...
                    var c");
                WriteLiteral(@"olumnIndex = $('#' + loadedTree + '_colname_' + $(this).val()).parent().index() + 1;
        ...
        function buildSecondInput(childNodes, loadedTree) {           
            ...
            childNodes.forEach(function element(treeNode, index, array) {
                //console.lo");
                WriteLiteral(@"g(treeNode.title + "" "" + treeNode.data.descripcion);                                                 
                ...
                if (treeNode.children != null) {                    
                    ...
                    treeNode.children.forEach(function element(treeSonNode1, index, array) {
                        ...
                        if (tree");
                WriteLiteral(@"SonNode1.children != null) {                                                 
                            ...
                            treeSonNode1.children.forEach(function element(treeSonNode2, index, array) {
                                ...
                                tableChildNodes = tableChildNodes + '<tr class="""" styl");
                WriteLiteral(@"e=""cursor:pointer;"">';
                            ...
                            tableChildNodes = tableChildNodes + '<tr>';
                            tableChildNodes = tableChildNodes + '<td><input onclick=""fnCheckFieldChanges(`' + treeSonNode1.data.descripcion + '`)"" value=""' + treeSonNode1.data.descripcion + '"" type");
                WriteLiteral(@"=""checkbox"" class=""checkbox_check_campo"" name=""checkbox_check_campo[]""></td>';
                            tableChildNodes = tableChildNodes + '<td><span class=""text-muted""> -->' + treeSonNode1.title + '</span></td>';
                            tableChildNodes = tableChildNodes + '<td><span class=""text-muted""> ' + treeSonNode1.data.descripcion + '</span></td>';
                            tableChildNodes = tableChildNodes + '</tr>';
     ...
     ");
            ...
            $('#modalContentFields').");
                WriteLiteral(@"append(footerBtns).fadeIn(300000);
        ...
        $(document).on('change', 'input[id=""checkAllDatosHijos""]', function () {
            ...
            if (checkedCampos.length > 0) {
                ...
                $('#btn");
                WriteLiteral(@"ApplySecondField').hide();
            }
  ...
  ");
            ...
            $.ajax({
                ...
                success: function (response) {                    
                    if (response > 0) {
                        ...
                        var nodo = tree.getActiveNode(); // para obtener el nodo activo.            
                        nodo.parent.resetLazy(); //rese");
                WriteLiteral(@"tear nodo para ver cambios reflejados
                    } else {
        ...
        async function ");
                WriteLiteral(@"removeColorsAndSizes(lvlID) {
        ...
        function addNHijos() {
            ...
            var vIDpar");
                WriteLiteral(@"ent = $('#txtIdParent').val();
  ...
  ");
                WriteLiteral(@"      function addHijosInDB(vCant, vNombre, vIDparent, vIDproject) {
            return $.ajax({
                type: ""POST"",
            ...
            if (colorsandsizes.length > 0) {               
                ...
                rpt1.then(function (res1) {
                    ...
                    colorsandsizes.forEach(function element(elemento, index, array) {
                        ...
                        var rpt2 = applyOrRemoveStyle(nodoId, elemento.va");
                WriteLiteral(@"lor, ""STYLE_APPLY"", elemento.campo)
                        rpt2.then(function (styleresponse) {
                            ...
                            if (elemento.tipo == ""color"") {
                                ...
                                if (elemento.campo == ""titulo"") {
                                    ...
                                    nodo.span.children[2].children[1].style.fontSiz");
                WriteLiteral(@"e = elemento.valor; //descripcion
                                }
                            }
                        });
        ...
        var tableToExcel = (function () {
            var uri = 'data:application/vnd.ms-excel;base64,'
                ...
                , base64 = function (s) { return window.btoa(unescape(encodeURIComp");
                WriteLiteral(@"onent(s))) }
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336f6302f67c02723665e72028e379547b8fa114128970", async() => {
                WriteLiteral("\r\n\r\n    <ul class=\"nav nav-tabs nav-fill\" data-bs-toggle=\"tabs\">\r\n\r\n");
#nullable restore
#line 2035 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                ...
                BeginWriteAttribute("href", " href=\"", 116918, "\"", 116951, 2);
                WriteAttributeValue("", 116925, "#proyecto_", 116925, 10, true);
#nullable restore
#line 2040 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 116935, item.ProyectoID, 116935, 16, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 116952, "\"", 117007, 6);
                WriteAttributeValue("", 116962, "loadTree(\'", 116962, 10, true);
#nullable restore
#line 2040 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 116972, item.ProyectoID, 116972, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 116988, "\',", 116988, 2, true);
                WriteAttributeValue(" ", 116990, "\'", 116991, 2, true);
#nullable restore
#line 2040 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 116992, item.Permiso, 116992, 13, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 117005, "\')", 117005, 2, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"nav-link active\"\r\n                       data-bs-toggle=\"tab\"><strong>");
#nullable restore
#line 2041 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                WriteLiteral("                <li class=\"nav-item\">\r\n                    <a");
                BeginWriteAttribute("href", " href=\"", 117312, "\"", 117345, 2);
                WriteAttributeValue("", 117319, "#proyecto_", 117319, 10, true);
#nullable restore
#line 2048 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 117329, item.ProyectoID, 117329, 16, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 117346, "\"", 117401, 6);
                WriteAttributeValue("", 117356, "loadTree(\'", 117356, 10, true);
#nullable restore
#line 2048 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 117366, item.ProyectoID, 117366, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 117382, "\',", 117382, 2, true);
                WriteAttributeValue(" ", 117384, "\'", 117385, 2, true);
#nullable restore
#line 2048 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 117386, item.Permiso, 117386, 13, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 117399, "\')", 117399, 2, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"nav-link\"\r\n                       data-bs-toggle=\"tab\">");
#nullable restore
#line 2049 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
                                       Write(Html.DisplayFor(modelItem => item.TB_PROYECTO.NombreProyecto));
...
#nullable disable
                WriteLiteral(")</a>\r\n                </li>\r\n");
#nullable restore
#line 2051 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
            }
        }
...
");
                WriteLiteral("\r\n                        </tr>\r\n                    </tbody>\r\n                </table>\r\n\r\n            </div>\r\n\r\n");
#nullable restore
#line 2187 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
             foreach (var item in Model)
            {
...
#nullable disable
                ...
                BeginWriteAttribute("id", " id=\"", 122924, "\"", 122954, 2);
                WriteAttributeValue("", 122929, "proyecto_", 122929, 9, true);
#nullable restore
#line 2189 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 122938, item.ProyectoID, 122938, 16, false);
...
#nullable disable
                ...
                BeginWriteAttribute("onclick", " onclick=\"", 123279, "\"", 123346, 5);
                WriteAttributeValue("", 123289, "loadColumnas(\'tree_", 123289, 19, true);
#nullable restore
#line 2196 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 123308, item.ProyectoID, 123308, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 123324, "\',\'", 123324, 3, true);
#nullable restore
#line 2196 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 123327, item.ProyectoID, 123327, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 123343, "\');", 123343, 3, true);
                EndWriteAttribute();
                WriteLiteral(" data-bs-toggle=\"modal\" data-bs-target=\"#modal-simple\">\r\n                                        Columnas\r\n                                    </a>\r\n                                </span>\r\n\r\n");
                WriteLiteral("\r\n                                <span class=\"d-none d-sm-inline\">\r\n                                    <a");
                BeginWriteAttribute("onclick", " onclick=\"", 124137, "\"", 124181, 3);
                WriteAttributeValue("", 124147, "expandOrContract(", 124147, 17, true);
#nullable restore
#line 2210 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 124164, item.ProyectoID, 124164, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 124180, ")", 124180, 1, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"btn btn-secondary\">\r\n                                        Expandir/Contraer\r\n                                    </a>\r\n                                </span>\r\n");
#nullable restore
#line 2214 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
");
#nullable restore
#line 2221 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
                                }
...
#nullable disable
                WriteLiteral("                            </div>\r\n                        </div>\r\n                    </div>\r\n\r\n\r\n                    <table");
                BeginWriteAttribute("id", " id=\"", 124941, "\"", 124967, 2);
                WriteAttributeValue("", 124946, "tree_", 124946, 5, true);
#nullable restore
#line 2227 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 124951, item.ProyectoID, 124951, 16, false);
...
#nullable disable
                ...
                WriteLiteral(@">
                        ...
                        <thead>
                            <tr");
                BeginWriteAttribute("id", " id=\"", 125253, "\"", 125284, 2);
                WriteAttributeValue("", 125258, "head_tree_", 125258, 10, true);
#nullable restore
#line 2234 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 125268, item.ProyectoID, 125268, 16, false);
...
");
                WriteLiteral("                            </tr>\r\n                        </tbody>\r\n                    </table>\r\n\r\n                </div>\r\n");
#nullable restore
#line 2299 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
            }
    ...
    <div class=""modal modal-blur fade"" id=""modal-color-admin"" tabin");
        ...
        <div class=""modal-dialog modal-dialog-centered"" role=""document"">
            ...
            <div class=""modal-content"" id=""modalColorFields"">
                ...
                BeginWriteAttribute("checked", " checked=\"", 137569, "\"", 137579, 0);
                EndWriteAttribute();
                WriteLiteral(@">
...
");
                ...
                BeginWriteAttribute("checked", " checked=\"", 143666, "\"", 143676, 0);
                EndWriteAttribute();
                WriteLiteral(@">
  ...
  ");
                ...
                BeginWriteAttribute("checked", " checked=\"", 148711, "\"", 148721, 0);
                EndWriteAttribute();
                WriteLiteral(@">
                ...
                BeginWriteAttribute("checked", " checked=\"", 150553, "\"", 150563, 0);
                EndWriteAttribute();
                WriteLiteral(@">
                                <span class=""form-check-label"" style=""font-size: 12px"">12px</span>
                            </label>
 ...
 ");
    ...
    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336f6302f67c02723665e72028e379547b8fa114170308", async() => {
                }
                );
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336f6302f67c02723665e72028e379547b8fa114171409", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336f6302f67c02723665e72028e379547b8fa114172510", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336f6302f67c02723665e72028e379547b8fa114173611", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336f6302f67c02723665e72028e379547b8fa114174712", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
