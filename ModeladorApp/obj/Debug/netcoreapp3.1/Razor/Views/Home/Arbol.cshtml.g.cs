#pragma checksum "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e6906b77efa8d84dedc1b08a31d4c735aed2ae26"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e6906b77efa8d84dedc1b08a31d4c735aed2ae26", @"/Views/Home/Arbol.cshtml")]
    ...
    public class Views_Home_Arbol : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<ModeladorApp.Models.Entities.TB_PERMISOS>>
    {
        ...
        {
            WriteLiteral("<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e6906b77efa8d84dedc1b08a31d4c735aed2ae263612", async() => {
                WriteLiteral(@"
            ...
            if (data.length >= 1) {
                ...
                WriteLiteral(@"NVO NODO
                                    ...
                                    if (typeof (data.node.parent.data.parentId) === 'undefined') {
                                        ...
                                        swal({
                                            title: ""ADVERTENCIA"",
                                            text: ""Se agregará un nodo hermano temporal, más no se guardará en tu proyecto."",
                                            type: ""warning""
                                        });
                           ...
                           ");
                WriteLiteral(@"                     ""parent"": data.node.parent.data.id,
                        ...
                        table: {
                            ...
                            nodeColumnIdx: 1,
                            //checkboxColumnIdx: 0");
                WriteLiteral(@", //para poner checkboxes en la columna 1
                        },
                        gridnav: {
                ...
                WriteLiteral(@"remove();
                 ...
                 ");
                WriteLiteral(@"           // Static markup (more efficiently defined as html row template):
                        ...
                        modifyChild: function (event, data) {
                            ...
                            if (data.node.parent != null && data.operation != ""add"") {
                                console.log(""entro al update"")
                              //------------------------>>AJAX Actualizar Nombre de No");
                WriteLiteral(@"do.
                              //$.ajax({
                              //    type: ""POST"",
                              //    dataType: ""json"",
                        ...
                        .on(""nod");
                WriteLiteral(@"eCommand"", function (event, data) {
       ...
       ");
                ...
                WriteLiteral(@"                            success: function (response) {
                                ...
                                case ""copy"":
                                    CLIPBOARD = {
                                        mode: data.cmd,
                                        data: nod");
                WriteLiteral(@"e.toDict(true, function (dict, node) {
                                            delete dict.key;
                                        }),
                                    };
                                    break;
               ...
               ");
                ...
                WriteLiteral(@"meta+v"": // mac
                                ...
                                case ""ctrl+up"":
");
                WriteLiteral(@"                                case ""ctrl+shift+up"": // mac
                                    cmd = ""moveUp"";
                                    break;
                                case ""ctrl+down"":
  ...
  ");
                WriteLiteral(@"                          // not interfere with the edit control
                            setTimeout(function () {
        ...
        function funGetPyFromUsuario(vIdProject) {
            ...
            return $.get(url, { idProyecto: ");
                WriteLiteral(@"vIdProject }, function (data) {
                //console.log(data);
            });
        };
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "e6906b77efa8d84dedc1b08a31d4c735aed2ae2630468", async() => {
                WriteLiteral(@"
...
#nullable disable
                ...
                BeginWriteAttribute("href", " href=\"", 25225, "\"", 25258, 2);
                WriteAttributeValue("", 25232, "#proyecto_", 25232, 10, true);
#nullable restore
#line 536 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 25242, item.ProyectoID, 25242, 16, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 25259, "\"", 25297, 3);
                WriteAttributeValue("", 25269, "loadTree(\'", 25269, 10, true);
#nullable restore
#line 536 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 25279, item.ProyectoID, 25279, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 25295, "\')", 25295, 2, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"nav-link\"\r\n                   data-bs-toggle=\"tab\">");
#nullable restore
#line 537 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
                ...
                WriteLiteral(@"                <col width=""2%""/>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td></td>
                            <td><input");
                BeginWriteAttribute("name", " name=\"", 27550, "\"", 27557, 0);
                EndWriteAttribute();
                WriteLiteral(" /></td>\r\n                            <td><input");
                BeginWriteAttribute("name", " name=\"", 27606, "\"", 27613, 0);
                EndWriteAttribute();
                WriteLiteral(" /></td>\r\n\r\n                        </tr>\r\n                    </tbody>\r\n                </table>\r\n\r\n            </div>\r\n\r\n");
#nullable restore
...
#nullable disable
                ...
                BeginWriteAttribute("id", " id=\"", 27831, "\"", 27861, 2);
                WriteAttributeValue("", 27836, "proyecto_", 27836, 9, true);
#nullable restore
#line 609 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 27845, item.ProyectoID, 27845, 16, false);
                    ...
                    <div class=""row align-items-center"">
                        <div class=""col-auto ms-auto d-print-none"">
                            <div class=""btn-list"">
                                <span class=""d-none d-sm-inline"">
                                    <a");
                BeginWriteAttribute("onclick", " onclick=\"", 28151, "\"", 28195, 3);
                WriteAttributeValue("", 28161, "expandOrContract(", 28161, 17, true);
#nullable restore
#line 615 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 28178, item.ProyectoID, 28178, 16, false);
...
#nullable restore
#line 619 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                WriteLiteral("                            </div>\r\n                        </div>\r\n                    </div>\r\n\r\n\r\n                    <table");
                BeginWriteAttribute("id", " id=\"", 28919, "\"", 28945, 2);
                WriteAttributeValue("", 28924, "tree_", 28924, 5, true);
#nullable restore
#line 632 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 28929, item.ProyectoID, 28929, 16, false);
                ...
                WriteLiteral(@">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td></td>
                                <td><input");
                BeginWriteAttribute("name", " name=\"", 29722, "\"", 29729, 0);
                EndWriteAttribute();
                WriteLiteral(" /></td>\r\n                                <td><input");
                BeginWriteAttribute("name", " name=\"", 29782, "\"", 29789, 0);
                EndWriteAttribute();
                WriteLiteral(" /></td>\r\n                            </tr>\r\n                        </tbody>\r\n                    </table>\r\n\r\n                </div>\r\n");
#nullable restore
#line 656 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
            }
