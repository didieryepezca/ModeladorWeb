#pragma checksum "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ee70768fcdd1cca456c3b98a9ac250ac1404f311"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ee70768fcdd1cca456c3b98a9ac250ac1404f311", @"/Views/Home/Arbol.cshtml")]
    ...
    public class Views_Home_Arbol : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<ModeladorApp.Models.Entities.TB_PERMISOS>>
    {
        ...
        {
            WriteLiteral("<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ee70768fcdd1cca456c3b98a9ac250ac1404f3113612", async() => {
                WriteLiteral(@"
    ...
    <script type=""text/javascript"">
                ...
                WriteLiteral(@"sult) {
                                ...
                                if (result.length != 0) {
                                    ...
                                    for (h = 0; h <= result.length - 1; h++) {
                                        ...
                                        colName = colName + '<th id=""' + treeReach + '_th' + h + '"" ><input id=""' + treeReach + '_coltitle' + h + '_' + result[h].tituloID + '"" onchange=""InsertUpdateTitulo(`' + treeReach + '_colname`,' + h + ',' + result[h].tituloID + ',' + pySelected + ' )"" type=""text"" value=""' + result[h].titulo + '""></th>';
                                    }
     ...
     ");
                WriteLiteral(@"                                   $('#' + treeReach + '_th' + f).remove(); //removemos para que no se vuelvan a crear.
                                        colName = colName + '<th id=""' + treeReach + '_th' + f + '"" ><input id=""' + treeReach + '_coltitle' + f +'"" onchange=""InsertUpdateTitulo(`' + treeReach + '_colname`,' + f + ',' + 0 + ',' + pySelected + ' )"" type=""text"" placeholder=""col nombre""></th>';
                                    }
                                    ...
                                    for (i = 1; i <= 50; i++) {
                                        ...
                                        colName = colName + '<th id=""' + treeReach + '_th' + i + '"" ><input id=""' + treeReach + '_coltitle' + i + '"" onchange=""InsertUpdateTitulo(`' + treeReach + '_coln");
                WriteLiteral(@"ame`,' + i + ',' + 0 + ',' + pySelected +' )"" type=""text"" placeholder=""col nombre ' + i + '""></th>';
                                    }
                                    $('#head_' + treeReach).append(colName).fadeIn(300000);
                ...
                WriteLiteral(@" i++) {
                                    ...
                                    cons");
                WriteLiteral(@"ole.log(""Construir desde 0"");
                                    for (k = 2; k <= 51; k++) {
                        ...
                        modifyChild: function (event, data) {
                            ...
                            //co");
                WriteLiteral(@"nsole.log(data.childNode.title); //nombre a actualizar
                            //console.log(""------------>>"")
                ...
                WriteLiteral(@"id,
                                ...
                                //console.log(data.childNode.data.id) //id para actualizar n");
                WriteLiteral(@"ombre del nodo padre
      ...
      ");
                WriteLiteral(@"                                      },
                                ...
                                case ""copy"":
                                    CLIPBOARD = {
                                        mode: data.cmd,
                                        data: node.toDict(");
                WriteLiteral(@"true, function (dict, node) {
                                            delete dict.key;
                                        }),
                                    };
                                    break;
          ...
          ");
                WriteLiteral(@"                  },
                            ...
                            {
                                t");
                WriteLiteral(@"itle: ""Ocultar Grilla"",
                                cmd: ""hidegrid"",
                            },
                            {
                                title: ""Nueva Columna"",
        ...
        async function funGetTitulos(pyId) {
            return titles = await funGetTitl");
                WriteLiteral(@"esFromDB(pyId);
        ...
        function InsertUpdateTitulo(tree, i, id, idpy, permiso) {
            ...
            if (id > 0) {
                ...
                var tituloUpdate = $('#' + tree + i + ""_"" + id).val();
                ...
                WriteLiteral(@"         type: ""POST"",
                    ...
                    success: function (response) {
                        ...
                        if (response > 0) {
                            ...
                            $('#' + tree + i).attr('id', tree + i + '_' + response);
 ...
 ");
      ...
      ");
        ...
        function EdicionInfo() {
            ...
            Swal.fire('EDITOR', 'Puedes editar éste p");
                WriteLiteral(@"royecto en su respectiva pestaña EDITOR, ya sea porque es tuyo o porque te concedieron dicho permiso.', 'info')
        ...
        var tableToExcel = (function () {
            ...
            return function (table, name) {
                if (!table.nodeType) table = document.getElem");
                WriteLiteral(@"entById(table)
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "ee70768fcdd1cca456c3b98a9ac250ac1404f31153345", async() => {
                WriteLiteral(@"
...
");
#nullable restore
#line 965 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                ...
                BeginWriteAttribute("href", " href=\"", 47095, "\"", 47128, 2);
                WriteAttributeValue("", 47102, "#proyecto_", 47102, 10, true);
#nullable restore
#line 968 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 47112, item.ProyectoID, 47112, 16, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 47129, "\"", 47184, 6);
                WriteAttributeValue("", 47139, "loadTree(\'", 47139, 10, true);
#nullable restore
#line 968 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 47149, item.ProyectoID, 47149, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 47165, "\',", 47165, 2, true);
                WriteAttributeValue(" ", 47167, "\'", 47168, 2, true);
#nullable restore
#line 968 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 47169, item.Permiso, 47169, 13, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 47182, "\')", 47182, 2, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"nav-link\"\r\n                   data-bs-toggle=\"tab\">");
#nullable restore
#line 969 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                WriteLiteral(")</a>\r\n            </li>\r\n");
#nullable restore
#line 971 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
        }
...
");
#nullable restore
#line 1094 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
             foreach (var item in Model)
            {
...
#nullable disable
                ...
                BeginWriteAttribute("id", " id=\"", 51924, "\"", 51954, 2);
                WriteAttributeValue("", 51929, "proyecto_", 51929, 9, true);
#nullable restore
#line 1096 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 51938, item.ProyectoID, 51938, 16, false);
                    ...
                    <div class=""row align-items-center"">
                        <div class=""col-auto ms-auto d-print-none"">
                            <div class=""btn-list"">
                                <span class=""d-none d-sm-inline"">
                                    <a");
                BeginWriteAttribute("onclick", " onclick=\"", 52244, "\"", 52288, 3);
                WriteAttributeValue("", 52254, "expandOrContract(", 52254, 17, true);
#nullable restore
#line 1102 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 52271, item.ProyectoID, 52271, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 52287, ")", 52287, 1, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"btn btn-secondary\">\r\n                                        Expandir/Contraer\r\n                                    </a>\r\n                                </span>\r\n");
#nullable restore
#line 1106 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                WriteLiteral("                            </div>\r\n                        </div>\r\n                    </div>\r\n\r\n\r\n                    <table");
                BeginWriteAttribute("id", " id=\"", 53048, "\"", 53074, 2);
                WriteAttributeValue("", 53053, "tree_", 53053, 5, true);
#nullable restore
#line 1119 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 53058, item.ProyectoID, 53058, 16, false);
...
#nullable disable
                ...
                WriteLiteral(@">
                        ...
                        <thead>
                            <tr");
                BeginWriteAttribute("id", " id=\"", 53360, "\"", 53391, 2);
                WriteAttributeValue("", 53365, "head_tree_", 53365, 10, true);
#nullable restore
#line 1126 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 53375, item.ProyectoID, 53375, 16, false);
...
");
#nullable restore
#line 1191 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
            }
