#pragma checksum "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8bf9453c87c656a5330c68e1754d64f297411035"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8bf9453c87c656a5330c68e1754d64f297411035", @"/Views/Home/Arbol.cshtml")]
    ...
    public class Views_Home_Arbol : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<ModeladorApp.Models.Entities.TB_PERMISOS>>
    {
        ...
        {
            WriteLiteral("<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8bf9453c87c656a5330c68e1754d64f2974110355659", async() => {
                WriteLiteral(@"
...
");
     ...
     ");
                WriteLiteral(@"                           title: ""Subrayar azul"",
                                cmd: ""bluesubrayado"",
                            }, {
      ...
      ");
                WriteLiteral(@"      var url = ""/Home/funGetLvlFromPyUsuario"";
        ...
        function InsertUpdateTitulo(tree, i, id, idpy, permiso) {
            ...
            if (typeof (permiso) === 'undefined' || permiso == ""VIEWER"") {
                ...
                Swal.fire('ADVERTENCIA', 'Puedes editar el proyecto en su respectiva pestaña EDITOR, si tienes ");
                WriteLiteral(@"el permiso correspondiente.', 'warning')
                        ...
                        success: function (response) {
                            ...
                            if (response > 0) {
                                ...
                                Swal.fire({
                                    ...
                                    icon: 'success',
              ");
                WriteLiteral(@"                      title: 'Titulo actualizado',
                                    animation: false,
                                    position: 'bottom',
                        ...
                        success: function (response) {
                            ...
                            if (response > 0) {
                                ...
                                Swal.fire({
                                    ...
                                    icon: 'success',
  ");
                WriteLiteral(@"                                  title: 'Titulo guardado',
                                    animation: false,
                                    position: 'bottom',
                                    showConfirmButton: false,
                                    timer: 3000,
        ...
        function funGetInfoFromDB(lvlI");
                WriteLiteral(@"D) {
        ...
        function insertOrUpdateInfoGrilla(tree, id, i, nodeId, permiso) {
            ...
            if (typeof (permiso) === 'undefined' || permiso == ""VIEWER"") {
                ...
                ");
                WriteLiteral(@"    var valorCajaUpdate = $('#' + tree + '_colvalue' + id).val();
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response > 0) {
                                ...
                                //removemos la funcion onc");
                WriteLiteral(@"hange y la volvemos a agregar solo con los parametros necesarios para la actualizacion.
        ...
        //Mensajito para la informacion que s");
                WriteLiteral(@"e puede editar proyecto
        ...
        function loadColumnas(loadedTree, vIdProyecto) {
            ...
            titulos.then(function (result) {
                ...
                result.forEach(function (element) {
                    ...
                    const idPushed = checkedColu");
                WriteLiteral(@"mns.find(x => x.idElement == element.tituloID);
                ...
                cuerpo_colu");
                WriteLiteral(@"mnas = cuerpo_columnas + '</tbody>';
        ...
        $(document).on('change', 'input[id=""checkAll""]', function () {
            checkedColumns = [];
            $('.");
                WriteLiteral(@"checkbox_check').prop(""checked"", this.checked);
       ...
       ");
        ...
        function fnApplyColumnChanges(loadedTree) {
            ...
            if (unCheckedColumns > 0) {
                jQuery(""input:checkbox:not(:checked)"").each(function () {
                    ...
                    $('#' + loadedTree +");
                WriteLiteral(@" ' td:nth-child(' + columnIndex + '),th:nth-child(' + columnIndex + ')').hide();
        ...
        function buildSecondInput(childNodes, loadedTree) {           
         ...
         ");
                WriteLiteral(@"       tableChildNodes = tableChildNodes + '<td><input onclick=""fnCheckFieldChanges(`' + treeNode.data.descripcion + '`)"" value=""' + treeNode.data.descripcion + '"" type=""checkbox"" class=""checkbox_check_campo"" name=""checkbox_check_campo[]""></td>';
            ...
            $.ajax({
                ...
                success: function (response) {                    
                    if (response > 0) {
                        ...
                        var nodo = tree.getActiveNode(); // para obtener el nodo activo.            
                        nodo.pare");
                WriteLiteral(@"nt.resetLazy(); //resetear nodo para ver cambios reflejados
                    } else {
 ...
 ");
                WriteLiteral(@"       async function removeColorsAndSizes(lvlID) {
...
");
                WriteLiteral(@"            var vIDparent = $('#txtIdParent').val();
     ...
     ");
                WriteLiteral(@"                   $('#modal-utilities').modal('toggle');
        ...
        async function addNHijosAsync(vCant, vNombre, vIDparent, vIDproject) {
            return hijos = await addHijosInDB(vCant, vNombre, vIDparent, vIDproje");
                WriteLiteral(@"ct);
        };
            ...
            if (colorsandsizes.length > 0) {               
                ...
                rpt1.then(function (res1) {
                    ...
                    colorsandsizes.forEach(function element(elemento, index, array) {
                        ...
                        var rpt2 = applyOrRemoveSty");
                WriteLiteral(@"le(nodoId, elemento.valor, ""STYLE_APPLY"", elemento.campo)
                        rpt2.then(function (styleresponse) {
                            ...
                            if (elemento.tipo == ""color"") {
                                ...
                                if (elemento.campo == ""titulo"") {
                                    ...
                                    nodo.span.children[2].chi");
                WriteLiteral(@"ldren[1].style.fontSize = elemento.valor; //descripcion
                                }
                            }
                        });
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8bf9453c87c656a5330c68e1754d64f297411035124549", async() => {
                WriteLiteral("\r\n\r\n    <ul class=\"nav nav-tabs nav-fill\" data-bs-toggle=\"tabs\">\r\n\r\n");
#nullable restore
#line 1975 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                ...
                BeginWriteAttribute("href", " href=\"", 112747, "\"", 112780, 2);
                WriteAttributeValue("", 112754, "#proyecto_", 112754, 10, true);
#nullable restore
#line 1980 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 112764, item.ProyectoID, 112764, 16, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 112781, "\"", 112836, 6);
                WriteAttributeValue("", 112791, "loadTree(\'", 112791, 10, true);
#nullable restore
#line 1980 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 112801, item.ProyectoID, 112801, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 112817, "\',", 112817, 2, true);
                WriteAttributeValue(" ", 112819, "\'", 112820, 2, true);
#nullable restore
#line 1980 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 112821, item.Permiso, 112821, 13, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 112834, "\')", 112834, 2, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"nav-link active\"\r\n                       data-bs-toggle=\"tab\"><strong>");
#nullable restore
#line 1981 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                WriteLiteral(")</a>\r\n                </li>\r\n");
#nullable restore
#line 1983 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                WriteLiteral("                <li class=\"nav-item\">\r\n                    <a");
                BeginWriteAttribute("href", " href=\"", 113141, "\"", 113174, 2);
                WriteAttributeValue("", 113148, "#proyecto_", 113148, 10, true);
#nullable restore
#line 1988 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 113158, item.ProyectoID, 113158, 16, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 113175, "\"", 113230, 6);
                WriteAttributeValue("", 113185, "loadTree(\'", 113185, 10, true);
#nullable restore
#line 1988 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 113195, item.ProyectoID, 113195, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 113211, "\',", 113211, 2, true);
                WriteAttributeValue(" ", 113213, "\'", 113214, 2, true);
#nullable restore
#line 1988 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 113215, item.Permiso, 113215, 13, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 113228, "\')", 113228, 2, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"nav-link\"\r\n                       data-bs-toggle=\"tab\">");
#nullable restore
#line 1989 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
                                       Write(Html.DisplayFor(modelItem => item.TB_PROYECTO.NombreProyecto));
...
#nullable disable
                WriteLiteral(")</a>\r\n                </li>\r\n");
#nullable restore
#line 1991 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
            }
        }
...
");
                WriteLiteral("\r\n                        </tr>\r\n                    </tbody>\r\n                </table>\r\n\r\n            </div>\r\n\r\n");
#nullable restore
#line 2127 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
             foreach (var item in Model)
            {
...
#nullable disable
                ...
                BeginWriteAttribute("id", " id=\"", 118753, "\"", 118783, 2);
                WriteAttributeValue("", 118758, "proyecto_", 118758, 9, true);
#nullable restore
#line 2129 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 118767, item.ProyectoID, 118767, 16, false);
...
#nullable disable
                ...
                BeginWriteAttribute("onclick", " onclick=\"", 119108, "\"", 119175, 5);
                WriteAttributeValue("", 119118, "loadColumnas(\'tree_", 119118, 19, true);
#nullable restore
#line 2136 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 119137, item.ProyectoID, 119137, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 119153, "\',\'", 119153, 3, true);
#nullable restore
#line 2136 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 119156, item.ProyectoID, 119156, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 119172, "\');", 119172, 3, true);
                EndWriteAttribute();
                WriteLiteral(" data-bs-toggle=\"modal\" data-bs-target=\"#modal-simple\">\r\n                                        Columnas\r\n                                    </a>\r\n                                </span>\r\n\r\n");
                WriteLiteral("\r\n                                <span class=\"d-none d-sm-inline\">\r\n                                    <a");
                BeginWriteAttribute("onclick", " onclick=\"", 119966, "\"", 120010, 3);
                WriteAttributeValue("", 119976, "expandOrContract(", 119976, 17, true);
#nullable restore
#line 2150 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 119993, item.ProyectoID, 119993, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 120009, ")", 120009, 1, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"btn btn-secondary\">\r\n                                        Expandir/Contraer\r\n                                    </a>\r\n                                </span>\r\n");
#nullable restore
#line 2154 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
");
#nullable restore
#line 2161 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
                                }
...
#nullable disable
                WriteLiteral("                            </div>\r\n                        </div>\r\n                    </div>\r\n\r\n\r\n                    <table");
                BeginWriteAttribute("id", " id=\"", 120770, "\"", 120796, 2);
                WriteAttributeValue("", 120775, "tree_", 120775, 5, true);
#nullable restore
#line 2167 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 120780, item.ProyectoID, 120780, 16, false);
...
#nullable disable
                ...
                WriteLiteral(@">
                        ...
                        <thead>
                            <tr");
                BeginWriteAttribute("id", " id=\"", 121082, "\"", 121113, 2);
                WriteAttributeValue("", 121087, "head_tree_", 121087, 10, true);
#nullable restore
#line 2174 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 121097, item.ProyectoID, 121097, 16, false);
    ...
    <div class=""modal modal-blur fade"" id=""modal-color-admin"" tabin");
        ...
        <div class=""modal-dialog modal-dialog-centered"" role=""document"">
            ...
            <div class=""modal-content"" id=""modalColorFields"">
                ...
                BeginWriteAttribute("checked", " checked=\"", 133398, "\"", 133408, 0);
                EndWriteAttribute();
                WriteLiteral(@">
...
");
                ...
                BeginWriteAttribute("checked", " checked=\"", 139495, "\"", 139505, 0);
                EndWriteAttribute();
                WriteLiteral(@">
  ...
  ");
                ...
                BeginWriteAttribute("checked", " checked=\"", 144540, "\"", 144550, 0);
                EndWriteAttribute();
                WriteLiteral(@">
                ...
                BeginWriteAttribute("checked", " checked=\"", 146382, "\"", 146392, 0);
                EndWriteAttribute();
                WriteLiteral(@">
                                <span class=""form-check-label"" style=""font-size: 12px"">12px</span>
                            </label>
 ...
 ");
    ...
    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8bf9453c87c656a5330c68e1754d64f297411035165887", async() => {
                }
                );
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8bf9453c87c656a5330c68e1754d64f297411035166988", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8bf9453c87c656a5330c68e1754d64f297411035168089", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8bf9453c87c656a5330c68e1754d64f297411035169190", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8bf9453c87c656a5330c68e1754d64f297411035170291", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
