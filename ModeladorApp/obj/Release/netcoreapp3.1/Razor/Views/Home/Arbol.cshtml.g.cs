#pragma checksum "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6e31f3ef860ddad24561abce318ae74eff91841e"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6e31f3ef860ddad24561abce318ae74eff91841e", @"/Views/Home/Arbol.cshtml")]
    ...
    public class Views_Home_Arbol : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<ModeladorApp.Models.Entities.TB_PERMISOS>>
    {
        ...
        {
            WriteLiteral("<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6e31f3ef860ddad24561abce318ae74eff91841e5659", async() => {
                WriteLiteral(@"
            ...
            ");
                ...
                WriteLiteral(@"break;
                                case ""duplicatelevel"":
                                    ...
                                    //console.log(""Añadir n hijos"");
                                    //console.log(node.data.id);
                                    var rpt = duplicateLevels(node.data.id, node.data.parentId, pySelected)
                                    rpt.then(function (response) {
                                        ...
                                        if (response > 0) {
                                            ...
                                            nodo.parent.resetLazy(); //recargamos el nodo parent para car");
                WriteLiteral(@"gar los id de los n elementos ingresados.
                ...
                ");
                WriteLiteral(@"                         buildSecondInput(childNodes, treeReach); //envio los datos de los hijos y el nodo para resetear el nodo padre.
                ...
                WriteLiteral(@"    //    //addColumn(treeReach, node.data.id);
                        ...
                        .on(""keydown"", function (e) {
                            ...
                            // console.log(e.");
                WriteLiteral(@"type, $.ui.fancytree.eventToString(e));
                ...
                WriteLiteral(@"+n"": // mac
                                ...
                                case ""ctrl+right"":
     ");
                WriteLiteral(@"                           case ""ctrl+shift+right"": // mac
                                    cmd = ""indent"";
                                    break;
                                case ""ctrl+left"":
 ...
 ");
                        ...
                        success: function (response) {
                            ...
                            if (response > 0) {
                                ...
                                Swal.fire({
                                    ...
                                    didOpen: (toast) => {
                                        toast.add");
                WriteLiteral(@"EventListener('mouseenter', Swal.stopTimer)
        ...
        function insertOrUpdateInfoGrilla(tree, id, i, nodeId, permiso) {
            ...
            if (typeof (permiso) === 'undefined' || permiso == ""VIEWER"") {
                ...
                Swal.fire('ADVERTENCIA', 'Puedes editar el proye");
                WriteLiteral(@"cto en su respectiva pestaña EDITOR, si tienes el permiso correspondiente.', 'warning')
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response > 0) {
                                ...
                                //cambiamos el i");
                WriteLiteral(@"d tambien por el nuevo con solo los parametros requeridos para la actualizacion.
   ...
   ");
        ...
        function fnShowHideColumns(loadedTree) {
            ...
            c");
                WriteLiteral(@"onsole.log(select);
...
");
                WriteLiteral(@"                        //console.log(""YA ESTA PUSHEADO:"" + idPushed)
        ...
        //----------------------------------------------------------> Manejo individual de los c");
                WriteLiteral(@"heckboxes de la función anterior.
        ...
        function fnApplyColumnChanges(loadedTree) {
            ...
            checkedColumns.forEach(function (checked_element) {
                ...
                var columnIndex = $('#' + loadedTree + '_colname_' + checked_element.idElement");
                WriteLiteral(@").parent().index() + 1;
        ...
        function buildSecondInput(childNodes, loadedTree) {           
            ...
            childNodes.forEach(function element(treeNode, index, array) {
                ...
                tableChildNodes = tableChildNodes + '<td><span class=""text-mute");
                WriteLiteral(@"d"">' + treeNode.data.descripcion + '</span></td>';
        ...
        //------------------------------>>> Chekar todos los checkbo");
                WriteLiteral(@"xes de los campos hijos
        ...
        function fnCheckFieldChanges(valor) {
            ...
            if ($('input.checkbox_check_campo').is(':checked') == true) {
                checkedCampos = [];
  ");
                WriteLiteral(@"              var m = jQuery('input:checkbox[class=checkbox_check_campo]:checked').length;
                if (m > 0) {
        ...
        function fnSetSecondFieldValue(loadedTree, id) {
            ...
            $.ajax({
                ...
                dataType: ""json"",
                url: ""/Home/fun");
                WriteLiteral(@"UpdateLvlDescriptionFromChilds"",
                data: {
                    ""Id"": id,
        ...
        async function applyOrRemoveStyle(lvlID, style, action) {
            return styleReponse = await applyOrRemoveStyleToDB(lvlID");
                WriteLiteral(@", style, action);
        };
    ...
    ");
        ...
        function addNHijos() {
            ...
            var nroCam");
                WriteLiteral(@"posLlenos = arrayHijos.length;
        ...
        //-------------------------------- Duplicar Niveles.
        async function duplicateLevels(vId,vPid,idPy) {
            return dups = await duplicateLevelsInDB(vId, vPid,idPy);
        };

        function duplicateLevelsInDB(vId, vPid, idPy) {
            return $.ajax({
                type: ""POST"",
        ...
        var tableToExcel = (function () {
            var uri = 'data:application/vnd.ms-excel;base64,'
                , template = '<html xmlns:o=""urn:schemas-microsoft-com:office:office"" xmlns:x=""urn:schemas-microsoft-com:office:excel"" xmlns=""http://www.w3.org/TR");
                WriteLiteral(@"/REC-html40""><head><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>{worksheet}</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--></head><body><table>{table}</table></body></html>'
        ...
        //    $");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6e31f3ef860ddad24561abce318ae74eff91841e99289", async() => {
                WriteLiteral("\r\n\r\n    <ul class=\"nav nav-tabs nav-fill\" data-bs-toggle=\"tabs\">\r\n\r\n");
#nullable restore
#line 1673 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                ...
                BeginWriteAttribute("href", " href=\"", 88546, "\"", 88579, 2);
                WriteAttributeValue("", 88553, "#proyecto_", 88553, 10, true);
#nullable restore
#line 1678 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 88563, item.ProyectoID, 88563, 16, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 88580, "\"", 88635, 6);
                WriteAttributeValue("", 88590, "loadTree(\'", 88590, 10, true);
#nullable restore
#line 1678 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 88600, item.ProyectoID, 88600, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 88616, "\',", 88616, 2, true);
                WriteAttributeValue(" ", 88618, "\'", 88619, 2, true);
#nullable restore
#line 1678 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 88620, item.Permiso, 88620, 13, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 88633, "\')", 88633, 2, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"nav-link active\"\r\n                       data-bs-toggle=\"tab\"><strong>");
#nullable restore
#line 1679 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                WriteLiteral(")</a>\r\n                </li>\r\n");
#nullable restore
#line 1681 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                WriteLiteral("                <li class=\"nav-item\">\r\n                    <a");
                BeginWriteAttribute("href", " href=\"", 88940, "\"", 88973, 2);
                WriteAttributeValue("", 88947, "#proyecto_", 88947, 10, true);
#nullable restore
#line 1686 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 88957, item.ProyectoID, 88957, 16, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 88974, "\"", 89029, 6);
                WriteAttributeValue("", 88984, "loadTree(\'", 88984, 10, true);
#nullable restore
#line 1686 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 88994, item.ProyectoID, 88994, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 89010, "\',", 89010, 2, true);
                WriteAttributeValue(" ", 89012, "\'", 89013, 2, true);
#nullable restore
#line 1686 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 89014, item.Permiso, 89014, 13, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 89027, "\')", 89027, 2, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"nav-link\"\r\n                       data-bs-toggle=\"tab\">");
#nullable restore
#line 1687 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
                                       Write(Html.DisplayFor(modelItem => item.TB_PROYECTO.NombreProyecto));
...
");
                WriteLiteral("\r\n                        </tr>\r\n                    </tbody>\r\n                </table>\r\n\r\n            </div>\r\n\r\n");
#nullable restore
#line 1825 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
             foreach (var item in Model)
            {
...
#nullable disable
                ...
                BeginWriteAttribute("id", " id=\"", 94574, "\"", 94604, 2);
                WriteAttributeValue("", 94579, "proyecto_", 94579, 9, true);
#nullable restore
#line 1827 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 94588, item.ProyectoID, 94588, 16, false);
...
#nullable disable
                ...
                BeginWriteAttribute("onclick", " onclick=\"", 94929, "\"", 94996, 5);
                WriteAttributeValue("", 94939, "loadColumnas(\'tree_", 94939, 19, true);
#nullable restore
#line 1834 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 94958, item.ProyectoID, 94958, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 94974, "\',\'", 94974, 3, true);
#nullable restore
#line 1834 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 94977, item.ProyectoID, 94977, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 94993, "\');", 94993, 3, true);
                EndWriteAttribute();
                WriteLiteral(" data-bs-toggle=\"modal\" data-bs-target=\"#modal-simple\">\r\n                                        Columnas\r\n                                    </a>\r\n                                </span>\r\n\r\n");
                WriteLiteral("\r\n                                <span class=\"d-none d-sm-inline\">\r\n                                    <a");
                BeginWriteAttribute("onclick", " onclick=\"", 95787, "\"", 95831, 3);
                WriteAttributeValue("", 95797, "expandOrContract(", 95797, 17, true);
#nullable restore
#line 1848 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 95814, item.ProyectoID, 95814, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 95830, ")", 95830, 1, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"btn btn-secondary\">\r\n                                        Expandir/Contraer\r\n                                    </a>\r\n                                </span>\r\n");
#nullable restore
#line 1852 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
");
#nullable restore
#line 1859 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
                                }
...
#nullable disable
                WriteLiteral("                            </div>\r\n                        </div>\r\n                    </div>\r\n\r\n\r\n                    <table");
                BeginWriteAttribute("id", " id=\"", 96591, "\"", 96617, 2);
                WriteAttributeValue("", 96596, "tree_", 96596, 5, true);
#nullable restore
#line 1865 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 96601, item.ProyectoID, 96601, 16, false);
...
#nullable disable
                ...
                WriteLiteral(@">
                        ...
                        <thead>
                            <tr");
                BeginWriteAttribute("id", " id=\"", 96903, "\"", 96934, 2);
                WriteAttributeValue("", 96908, "head_tree_", 96908, 10, true);
#nullable restore
#line 1872 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 96918, item.ProyectoID, 96918, 16, false);
...
");
                WriteLiteral("                            </tr>\r\n                        </tbody>\r\n                    </table>\r\n\r\n                </div>\r\n");
#nullable restore
#line 1937 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
            }
...
#nullable disable
    ...
    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6e31f3ef860ddad24561abce318ae74eff91841e121121", async() => {
                }
                );
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6e31f3ef860ddad24561abce318ae74eff91841e122222", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6e31f3ef860ddad24561abce318ae74eff91841e123323", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6e31f3ef860ddad24561abce318ae74eff91841e124424", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6e31f3ef860ddad24561abce318ae74eff91841e125525", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
