#pragma checksum "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "36b784eb15704d27dff3867b943a3ebe8fddfb9a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"36b784eb15704d27dff3867b943a3ebe8fddfb9a", @"/Views/Home/Arbol.cshtml")]
    ...
    public class Views_Home_Arbol : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<IEnumerable<ModeladorApp.Models.Entities.TB_PERMISOS>>
    {
        ...
        {
            WriteLiteral("<html>\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("head", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "36b784eb15704d27dff3867b943a3ebe8fddfb9a4681", async() => {
                WriteLiteral(@"
    ...
    <script type=""text/javascript"">
        ...
        async function loadTree(vIdProject, vPermiso) {
            ...
            if (data.length >= 1) {
             ...
             ");
                WriteLiteral(@"                               node.span.style.backgroundColor = estilosresponse[s].style;  //SUBRAYADO VERDE.
                ...
                WriteLiteral(@"se if (estilosresponse[s].style == 'true') {
                                            console.log(""FOLDER"")
                ...
                WriteLiteral(@"                  for (f = g; f <= 48; f++) {
                                    ...
                                    for (i = 1; i <= 48; i++) {
                                        ...
                                        colName = colName + '<th id=""' + treeReach + '_colth_'");
                WriteLiteral(@" + i + '""><input id=""' + treeReach + '_colname' + i + '"" onchange=""InsertUpdateTitulo(`' + treeReach + '_colname`,' + i + ',' + 0 + ',' + pySelected + ',`' + vPermiso + '`  )"" type=""text"" placeholder=""col nombre ' + i + '"" style=""width: 60px;""></th>';
                                    }
                                    $('#head_' + treeReach).append(colName).fadeIn(300000);
                                ...
                                case ""remove"":
                                    ...
                                    if (data.cmd == ""remove"" && vPermiso == ""EDITOR"") {
                                        ...
                                        $.ajax({
                                            ...
                                            dataType: ""json"",
                                ");
                WriteLiteral(@"            url: ""/Home/funDeleteLvlAndSublvls"",
                                            data: {
                                                ""Id"": node.data.id,
                                            },
                                            success: function (response) {
 ...
 ");
                                ...
                                case ""applybold"":
                                    ...
                                    rpt.then(function (styleresponse) {
                                        ...
                                        if (styleresponse > 0) {
                                            ...
                                            Swal.fire('ERROR', 'Hubo un problema, probablemente el est");
                WriteLiteral(@"ilo ya existe.', 'warning')
                                        }
                                    });
                                    //if(statusText)
                                ...
                                case ""removebold"":
                                    ...
                                    rpt.then(function (styleresponse) {
                                        ...
                                        if (styleresponse > 0) {
                                            ...
                                            Swal.fire('ERROR', 'Hubo un problema quitando el estil");
                                ...
                                case ""applyitalic"":
                                    ...
                                    rpt.then(function (styleresponse) {
                                        ...
                                        if (styleresponse > 0) {
                                            ...
                                            Swal.fire('ERROR', 'Hubo un problema, probablemente el estilo ya existe.', 'wa");
                WriteLiteral(@"rning')
                                        }
                                    });
                                    //console.log(node.data.id); // id del nodo.
                                ...
                                case ""removeitalic"":
                                    ...
                                    rpt.then(function (styleresponse) {
                                        ...
                                        if (styleresponse > 0) {
                                            ...
                                            Swal.fire('ERROR', 'Hubo un problema quitando");
                WriteLiteral(@" el estilo', 'warning')
                                        }
                                    });
                                    //console.log(node.data.id); // id del nodo.
                                    //addColumn(treeReach, node.data.id);
  ...
  ");
                WriteLiteral(@"                                          Swal.fire('ERROR', 'Hubo un problema, si ya cuenta con un subrayado quítelo antes de agregar otro.', 'warning')
                                ...
                                case ""yellowsubrayado"":
                                    ...
                                    rpt.then(function (styleresponse) {
                                        //console.log(styleresponse);
                                        if (styleresponse > 0) {
                                            node.span.style.backgro");
                WriteLiteral(@"undColor = ""Yellow"";
                                        } else {
                ...
                WriteLiteral(@"nse);
                             ...
                             ");
                WriteLiteral(@"       var rpt2 = applyOrRemoveStyle(node.data.id, ""Aqua"", ""STYLE_REMOVE"")                                    
    ...
    ");
                WriteLiteral(@"                                var rpt = applyOrRemoveStyle(node.data.id, ""true"", ""STYLE_APPLY"")
                                    rpt.then(function (styleresponse) {
                                        //console.log(styleresponse);
                                        if (styleresponse > 0) {
                                            node.folder = true;
                                ...
                                case ""removefoldericon"":
                                    //tree.applyCommand(data.cmd, node);
                                   ");
                WriteLiteral(@" console.log(""Quitar icono de folder"");
      ...
      ");
        ...
        function InsertUpdateTitulo(tree, i, id, idpy, permiso) {
            ...
            if (typeof (permiso) === 'undefined' || permiso == ""VIEWER"") {
                ...
                if (id > 0) {
                    ...
                    dataToGo = { ""id"": id, ""title"": t");
                WriteLiteral(@"ituloUpdate }
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response > 0) {
                                ...
                                $('#' + tree + i).attr('onc");
                WriteLiteral(@"hange', ""InsertUpdateTitulo('"" + tree + ""','"" + i + ""','"" + response + ""','"" + idpy + ""','"" + permiso + ""')"");
                                ...
                                Swal.fire({
                                    ...
                                    timerProgressBar: true,
                                    didOpen: (toast) => {
                                        toast.addEventListener('mouseenter', S");
                WriteLiteral(@"wal.stopTimer)
                                        toast.addEventListener('mouseleave', Swal.resumeTimer)
                                    }
                                })
                                ...
                                Swal.fire({
                                    ...
                                    didOpen: (toast) => {
                                        toast.addEventListener('mouseenter', Swal.stopTimer)
                                        toast.addEventListener('mouseleave', Swal.resume");
                WriteLiteral(@"Timer)
                                    }
                                })
                            }
        ...
        function insertOrUpdateInfoGrilla(tree, id, i, nodeId, permiso) {
            ...
            if (typeof (permiso) === 'undefined' || permiso == ""VIEWER"") {
                ...
                Swal.fire('ADVERTENCIA', 'Puedes editar el proyecto en su respectiva pestaña EDITOR, s");
                WriteLiteral(@"i tienes el permiso correspondiente.', 'warning')
                ...
                WriteLiteral(@"       toast: true,
                    ...
                    var valorCajaInsert = $('#' + tr");
                WriteLiteral(@"ee + '_colvalue_' + i + ""_"" + nodeId).val();
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response > 0) {
                                ...
                                //cambiamos el id tambien por el nuevo con solo los pa");
                WriteLiteral(@"rametros requeridos para la actualizacion.
    ...
    ");
        ...
        var tableToExcel = (function () {
            var uri = 'data:application/vnd.ms-excel;base64,'
                , template = '<html xmlns:o=""urn:schemas-microsoft-com:office:office"" xmlns:x=""urn:schemas-microsoft-com:office:excel"" xml");
                WriteLiteral(@"ns=""http://www.w3.org/TR/REC-html40""><head><!--[if gte mso 9]><xml><x:ExcelWorkbook><x:ExcelWorksheets><x:ExcelWorksheet><x:Name>{worksheet}</x:Name><x:WorksheetOptions><x:DisplayGridlines/></x:WorksheetOptions></x:ExcelWorksheet></x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]--></head><body><table>{table}</table></body></html>'
        ...
        function fnCheckColumnChanges() {
            ...
            if ($('input.checkbox_check').is(':checked') == true) {
                checkedColumns = [];
                var m = jQuery('input:checkbox[class=c");
                WriteLiteral(@"heckbox_check]:checked').length;
                if (m > 0) {
        ...
        function fnApplyColumnChanges(loadedTree) {
            ...
            ");
                WriteLiteral(@"var unCheckedColumns = $(""input:checkbox:not(:checked)"").length;
...
");
            ...
            WriteLiteral("\r\n\r\n");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "36b784eb15704d27dff3867b943a3ebe8fddfb9a83099", async() => {
                WriteLiteral(@"
...
");
#nullable restore
#line 1429 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                ...
                BeginWriteAttribute("href", " href=\"", 74494, "\"", 74527, 2);
                WriteAttributeValue("", 74501, "#proyecto_", 74501, 10, true);
#nullable restore
#line 1432 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 74511, item.ProyectoID, 74511, 16, false);

#line default
#line hidden
#nullable disable
                EndWriteAttribute();
                BeginWriteAttribute("onclick", " onclick=\"", 74528, "\"", 74583, 6);
                WriteAttributeValue("", 74538, "loadTree(\'", 74538, 10, true);
#nullable restore
#line 1432 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 74548, item.ProyectoID, 74548, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 74564, "\',", 74564, 2, true);
                WriteAttributeValue(" ", 74566, "\'", 74567, 2, true);
#nullable restore
#line 1432 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 74568, item.Permiso, 74568, 13, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 74581, "\')", 74581, 2, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"nav-link\"\r\n                   data-bs-toggle=\"tab\">");
#nullable restore
#line 1433 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
#nullable disable
                WriteLiteral(")</a>\r\n            </li>\r\n");
#nullable restore
#line 1435 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
        }
...
");
        ...
        <div class=""tab-content"">
            ...
            <div class=""tab-pane"" id=""proyecto_0"">
                        ...
                        <div class=""btn-list"">
                            ...
                            <span class=""d-none d-sm-inline"">
                                <select class=""form-select"" id=""selectColumnas"" onchange=""fnShowHideColumns('tree_0');"">
                                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "36b784eb15704d27dff3867b943a3ebe8fddfb9a87546", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n                                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "36b784eb15704d27dff3867b943a3ebe8fddfb9a88686", async() => {
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n                                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "36b784eb15704d27dff3867b943a3ebe8fddfb9a89953", async() => {
...
#nullable disable
                ...
                BeginWriteAttribute("id", " id=\"", 80240, "\"", 80270, 2);
                WriteAttributeValue("", 80245, "proyecto_", 80245, 9, true);
#nullable restore
#line 1576 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 80254, item.ProyectoID, 80254, 16, false);
...
#nullable disable
                ...
                BeginWriteAttribute("onclick", " onclick=\"", 80595, "\"", 80662, 5);
                WriteAttributeValue("", 80605, "loadColumnas(\'tree_", 80605, 19, true);
#nullable restore
#line 1583 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 80624, item.ProyectoID, 80624, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 80640, "\',\'", 80640, 3, true);
#nullable restore
#line 1583 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 80643, item.ProyectoID, 80643, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 80659, "\');", 80659, 3, true);
                EndWriteAttribute();
                ...
                BeginWriteAttribute("onchange", " onchange=\"", 81011, "\"", 81065, 3);
                WriteAttributeValue("", 81022, "fnShowHideColumns(\'tree_", 81022, 24, true);
#nullable restore
#line 1590 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 81046, item.ProyectoID, 81046, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 81062, "\');", 81062, 3, true);
                EndWriteAttribute();
                WriteLiteral(">\r\n                                        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "36b784eb15704d27dff3867b943a3ebe8fddfb9a97808", async() => {
                    WriteLiteral("Columnas");
                }
                );
                __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n                                        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "36b784eb15704d27dff3867b943a3ebe8fddfb9a98952", async() => {
                    WriteLiteral("Mostrar todas");
                }
                );
                __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n                                        ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "36b784eb15704d27dff3867b943a3ebe8fddfb9a100223", async() => {
                    WriteLiteral("Ocultar todas");
                }
                );
                __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
                ...
                __tagHelperExecutionContext = __tagHelperScopeManager.End();
                WriteLiteral("\r\n                                    </select>\r\n                                </span>\r\n\r\n\r\n                                <span class=\"d-none d-sm-inline\">\r\n                                    <a");
                BeginWriteAttribute("onclick", " onclick=\"", 81521, "\"", 81565, 3);
                WriteAttributeValue("", 81531, "expandOrContract(", 81531, 17, true);
#nullable restore
#line 1599 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 81548, item.ProyectoID, 81548, 16, false);

#line default
#line hidden
#nullable disable
                WriteAttributeValue("", 81564, ")", 81564, 1, true);
                EndWriteAttribute();
                WriteLiteral(" class=\"btn btn-secondary\">\r\n                                        Expandir/Contraer\r\n                                    </a>\r\n                                </span>\r\n");
#nullable restore
#line 1603 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
...
");
#nullable restore
#line 1610 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
                                }
...
#nullable disable
                WriteLiteral("                            </div>\r\n                        </div>\r\n                    </div>\r\n\r\n\r\n                    <table");
                BeginWriteAttribute("id", " id=\"", 82325, "\"", 82351, 2);
                WriteAttributeValue("", 82330, "tree_", 82330, 5, true);
#nullable restore
#line 1616 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 82335, item.ProyectoID, 82335, 16, false);
...
#nullable disable
                ...
                WriteLiteral(@">
                        ...
                        <thead>
                            <tr");
                BeginWriteAttribute("id", " id=\"", 82637, "\"", 82668, 2);
                WriteAttributeValue("", 82642, "head_tree_", 82642, 10, true);
#nullable restore
#line 1623 "C:\Users\didie\source\repos\ModeladorApp\ModeladorApp\Views\Home\Arbol.cshtml"
WriteAttributeValue("", 82652, item.ProyectoID, 82652, 16, false);
